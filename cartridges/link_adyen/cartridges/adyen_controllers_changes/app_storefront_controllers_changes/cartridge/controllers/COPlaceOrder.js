...
function start() {
  ...
  handlePaymentsResult.isAdyen && !handlePaymentsResult.action || handlePaymentsResult.action && handlePaymentsResult.action.type === constants.ACTIONTYPES.VOUCHER || !handlePaymentsResult.action && !handlePaymentsResult.isFinal; // no action and payment is not final (SEPA)
