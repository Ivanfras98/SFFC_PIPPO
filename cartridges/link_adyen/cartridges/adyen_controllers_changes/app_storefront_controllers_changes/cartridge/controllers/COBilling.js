  ...
  if (cart) {
    ...
    Transaction.wrap(function () {
      ...
      for (j = 0; j < gcIdList.length; j += 1) {
        ...
        if (gc && gc.isEnabled() && gc.getStatus() !== GiftCertificate.STATUS_PENDING && gc.getStatus() !== GiftCertificate.STATUS_REDEEMED && gc.balance.currencyCode === cart.getCurrencyCode()) {
